...
#    Updated: 2023/08/23 15:50:56 by sbenes           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = 	main.c error.c utils.c parser.c \
	init_objects.c init_objects_utils.c init_object_utils2.c init_scene.c init_scene_utils.c init.c\
	events.c exit.c render.c vector_operations.c vector_operations_utils.c hit_sphere.c ray.c ray_utils.c hit_plane.c\
	hit_cylinder.c light.c light_utils.c shadow.c
